...
# Create route table associations for private subnet 1
...
# Create the route table associations for private subnet 2
...
#create the ALBSG security group
...
#########################
# Task 5 :  Create high availability using an ALB
...
resource "aws_launch_template" "WebLT" {
  ...
  iam_instance_profile {
    # arn = aws_iam_instance_profile.LT_profile.arn 
